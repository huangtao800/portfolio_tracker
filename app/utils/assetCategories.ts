...
export const assetCategories: AssetCategoryMapping = {
  ...
  'VXUS': { category: 'International Equity', subCategory: 'Foreign Large Blend' },
  'IXUS': { category: 'International Equity', subCategory: 'Foreign Large Blend' },
  'SCHF': { category: 'International Equity', subCategory: 'Foreign Large Blend' },
